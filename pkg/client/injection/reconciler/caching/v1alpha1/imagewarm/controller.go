...
import (
	...
	versionedscheme "knative.dev/cache-imagewarm/pkg/client/clientset/versioned/scheme"
	client "knative.dev/cache-imagewarm/pkg/client/injection/client"
	imagewarm "knative.dev/cache-imagewarm/pkg/client/injection/informers/caching/v1alpha1/imagewarm"
...
const (
	defaultControllerAgentName = "imagewarm-controller"
	defaultFinalizerName       = "imagewarms.caching.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	imagewarmInformer := imagewarm.Get(ctx)

	lister := imagewarmInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "caching.knative.dev.ImageWarm"),
	)
