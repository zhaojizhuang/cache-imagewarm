...
`cache-imagewarm`. Also take a look at:
...
`src/knative.dev/cache-imagewarm` directory in your
...
git clone git@github.com:${YOUR_GITHUB_USERNAME}/cache-imagewarm.git
cd cache-imagewarm
